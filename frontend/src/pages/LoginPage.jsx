  ...
  return (
    <form id="sign-in" className="login-panel" onSubmit={handleSubmit}>
      <div className="login-panel__header">
        ...
        <div>
          <h2>Welcome back.</h2>
          <p>Sign in to your live Feed</p>
        </div>
      </div>

      <div className="security-strip">
        <ShieldCheck size={16} />
        <span>Your Feed. Your conversations. Securely connected.</span>
      </div>
      ...
      <button type="submit" disabled={loading} className="primary login-submit">
        {loading ? 'Signing in…' : 'Open your Feed'}
        <ArrowRight size={16} />
      </button>
    </form>
  );
  ...
  return <main className="landing">
    ...
    <section className="landing-hero">
      <div className="landing-intro">
        ...
        {import.meta.env.DEV && <Link to="/design-preview" className="preview-entry">Explore the local Feed preview <ArrowRight size={16} /></Link>}
      </div>
      <LoginForm />
    </section>
